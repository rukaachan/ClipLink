...
$workerProject = Join-Path $repoRoot "src\ClipLink.Worker\ClipLink.Worker.csproj"
$cliProject = Join-Path $repoRoot "src\ClipLink.Cli\ClipLink.Cli.csproj"
...
Write-Host ""
Write-Host "ClipLink installed to: $InstallDir"
if ($pathAdded) {
    Write-Host "Added to your user PATH. Open a new terminal to use 'cliplink' everywhere."
}
else {
